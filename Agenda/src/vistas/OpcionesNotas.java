 ...
 * @author edwin
 */
public class OpcionesNotas extends javax.swing.JDialog {

    int x,y;/**
     * Creates new form OpcionesNotas
     */
    public OpcionesNotas(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagenes/apuntesTitulo.png"))); // NOI18N
        jLabel1.setText("OPCIONES DE MIS NOTAS");
        ...
        BtnAgregar.setText("AGREGAR NOTAS");
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        AgregarNota AgAp = new AgregarNota(new javax.swing.JDialog(),true);
        AgAp.setVisible(true);
    ...
    private void BtnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnVerActionPerformed
        MostrarNota Ver = new MostrarNota(new javax.swing.JDialog(),true);
        Ver.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpcionesNotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OpcionesNotas dialog = new OpcionesNotas(new javax.swing.JDialog(), true);
